...
# 1. Especificações OMG

## 1.1. Fonte: https://www.omg.org/spec/ (acessado via webfetch)

## 1.2. Especificações Atualizadas Recentemente (últimos 6 meses)
...
## 1.3. Especificações Adotadas pela ISO
...
## 1.4. Lista Completa de Especificações (Contagem: 282)
...
## 1.5. Links de Download Diretos para Normas-Chave MDA/MBSE
...
- **MDA Guide**: https://www.omg.org/cgi-bin/doc?ormsc/14-06-01.pdf
- **SBVR 1.1**: https://www.omg.org/spec/SBVR/1.1  
- **SPEM 2.0**: https://www.omg.org/spec/SPEM/2.0  

# 2. Checklist de Normas OMG para MBSE/MDA

## 2.1. Normas Fundamentais
...
## 2.2. Normas Adicionais/Especializadas
