# instruções para validação de code blocks
...
Usado pelo agente `meta-api-code-block-reviewer` para validar code blocks em planos de implementacao antes da codificacao real, conferindo se respeitam as regras de consistencia da arquitetura.
