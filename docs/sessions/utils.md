...
# 3. automation
## 3.1. regex |[vscode](file:///C:/Users/muril/OneDrive/01%20mycloud/01%20sistMu/20.01%20obsidianPkm/20%20km_ssg/10_info_km_ssg/20%20%20automacao/02_parsing_regex/251012%20regex.md), [[251012 regex|obsidian]]|

## 3.2. python 

### 3.2.1. venv [venv](file:///C:/Users/muril/OneDrive/01%20mycloud/01%20sistMu/20.01%20obsidianPkm/20%20km_ssg/10_info_km_ssg/20%20%20automation/10.03%20python/251023%20venv.md)

ativar venv: C:\Users\muril\venvs\pessoal\Scripts\Activate.ps1

## 3.3. gcloud (google api)
- gcloud init
...
### 3.3.1. ativação chave api gemini [aistudio.google](https://aistudio.google.com/api-keys)
...
### 3.3.2. listar modelos disponiveis
```powershell
...
### 3.3.3. request direta API People

#### 3.3.3.1. get contacts
```powershell
...
### 3.3.4. google sheets cli

#### 3.3.4.1. Comandos de edição disponíveis
...
## 5.1. wsl [help](file:///C:/Users/muril/OneDrive/01%20mycloud/01%20sistMu/20.01%20obsidianPkm/20%20km_ssg/10_info_km_ssg/20%20%20automacao/01_msWindows/WSL%20linux%20bash.md)
...
## 5.3. postgresql [bin](file:///C:/Program%20Files/PostgreSQL/18/bin)
...
# 6. SDLC
## 6.1. github |[vscode](file:///C:/Users/muril/OneDrive/01%20mycloud/01-sistMu/21-obsidianPkm/20-km_ssg/10_info_km_ssg/20%20%20automation/250930-git.md), [[250930-git|obsidian]]|
