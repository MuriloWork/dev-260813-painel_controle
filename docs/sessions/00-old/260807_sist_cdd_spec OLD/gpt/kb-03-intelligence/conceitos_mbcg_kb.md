...
# 2. Especificações originais para produção dos documentos OKF
...
## 2.1. Arquitetura fisica: Knowledge Bundle
...
## 2.2. Lógica semântica e operacional
...
# 3. Configurações para produção dos documentos OKF do MB-Code-Generator
## 3.1. resumo
...
## 3.2. Configurações para os conceitos originais
...
## 3.3. OLD Configurações para os conceitos originais

### 3.3.1. Natureza do Concept
...
### 3.3.3. Classificação do Concept
...
## 3.4. Configurações complementares
...
### 3.4.6. Consistência terminológica
...
### 3.4.7. Separação entre conceito e representação
...
### 3.4.11. O que mudou conceitualmente
...
# 4. Relacionamentos entre conceitos
...
# 5. Convenções específicas do MBCG
