...
[GitHub OKF](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md)
# 1. Version 0.2
...
A bundle is a directory tree of markdown files. The directory structure is independent of the domain: producers organize concepts however make sense for the knowledge being captured.
...
## 5.3. Example: a concept bound to a resource
...
## 5.4. Example: a concept not bound to a resource
...
# 7. Cross-linking and paths

## 7.1. Links between concepts
...
# 11. Attested computations concept
...
## 11.1. A computation is its own concept
...
## 11.4. Concepts that use a computation
...
## 11.5. How a consumer uses it (informative)
...
## 11.6. Verification versus attestation
...
# 15. Appendix A: Worked example, an income statement
